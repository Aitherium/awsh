...
// Fallback agent names when Genesis is unreachable. GENERATED from the identity
// registry by gen_sovereign_roster.py (the same list the harness daemon accepts).
const DEFAULT_AGENTS = [
  // roster:begin -- GENERATED by gen_sovereign_roster.py from the identity registry;
  // do not hand-edit (regenerate; --check names drift).
  'aither', 'aeon', 'aeros', 'athena', 'atlas', 'automation', 'demiurge', 'hera', 'hydra',
  'ignis', 'iris', 'lust', 'lyra', 'morgana', 'mrrobot', 'plutus', 'prometheus', 'reasoner',
  'saga', 'terra', 'themis', 'vera', 'viviane', 'wrath',
  // roster:end
];
